...
O objetivo deste projeto é aplicar os conhecimentos sobre MySQL. Normalizar e popular uma tabela não normalizada, para que seja possível executar queries sobre ela com o intuito de encontrar as informações solicitadas.
...
1. Clone o repositório
  * `git clone git@github.com:anacarol-r-santos/project-one-for-all.git`.
